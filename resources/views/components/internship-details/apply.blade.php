            ...
            <div class="inline-flex gap-2.5 justify-start items-end size-">
                ...
                <div class="inline-flex flex-col items-start justify-start gap-1 w-14">
                    <div
                        ...
                        Applied </div>
                    <div
                        class="self-stretch justify-start text-main text-sm font-medium font-['Poppins'] tracking-wide">
                        {{ $people }}</div>
                </div>
            </div>
        </div>
        <div class="flex items-center p-2 rounded-lg">
            <div class="inline-flex gap-2.5 justify-start items-end size-">
                <div
                    ...
                    <div data-svg-wrapper class="relative">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12.5 2.5C7.25 2.5 3 6.75 3 12s4.25 9.5 9.5 9.5S22 17.25 22 12 17.75 2.5 12.5 2.5zm0 17c-4.14 0-7.5-3.36-7.5-7.5s3.36-7.5 7.5-7.5 7.5 3.36 7.5 7.5-3.36 7.5-7.5 7.5z"
                                fill="#393939" />
                            <path
                                d="M12.5 7.5c-2.48 0-4.5 2.02-4.5 4.5s2.02 4.5 4.5 4.5 4.5-2.02 4.5-4.5-2.02-4.5-4.5-4.5zm0 7c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"
                                fill="#393939" />
                        </svg>
                    </div>
                </div>
                <div class="inline-flex flex-col items-start justify-start gap-1 w-14">
                    ...
                    <div
                        class="self-stretch justify-start text-main text-sm font-medium font-['Poppins'] tracking-wide">
                        {{ Str::ucfirst(str_replace('_', '-', $type)) }}</div>
                </div>
            </div>
        </div>
    </div>
