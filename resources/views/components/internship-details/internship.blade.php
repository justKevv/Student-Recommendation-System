...
<div class="overflow-hidden relative p-0 bg-white rounded-xl">
    ...
    <div class="relative p-6 pb-8 ml-2 shadow-">
        ...
        <div class="mt-4">
                ...
                <div class="inline-flex gap-1.5 justify-center items-center size-">
                    <div data-svg-wrapper class="relative">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                d="M3 21.002V8.00195L16 3.00195V12.002H17C17 11.452 17.1958 10.9811 17.5875 10.5895C17.9792 10.1978 18.45 10.002 19 10.002C19.55 10.002 20.0208 10.1978 20.4125 10.5895C20.8042 10.9811 21 11.452 21 12.002V21.002H3ZM5 19.002H9V12.002H14V5.90195L5 9.37695V19.002ZM11 19.002H14V16.002H16V19.002H19V14.002H11V19.002Z"
                                fill="#393939" />
                        </svg>
                    </div>
                    <a href="{{ $href }}" class="justify-start text-main text-base font-normal font-['Poppins'] hover:underline transition-all duration-200">{{ $company }}
                    </a>
                </div>
            </div>
            <div class="flex items-center mt-1 text-base text-main">
                <div class="inline-flex gap-1.5 justify-center items-center size-">
                    <div data-svg-wrapper class="relative">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 12.002C12.55 12.002 13.0208 11.8061 13.4125 11.4145C13.8042 11.0228 14 10.552 14 10.002C14 9.45195 13.8042 8.98112 13.4125 8.58945C13.0208 8.19779 12.55 8.00195 12 8.00195C11.45 8.00195 10.9792 8.19779 10.5875 8.58945C10.1958 8.98112 10 9.45195 10 10.002C10 10.552 10.1958 11.0228 10.5875 11.4145C10.9792 11.8061 11.45 12.002 12 12.002ZM12 19.352C14.0333 17.4853 15.5417 15.7895 16.525 14.2645C17.5083 12.7395 18 11.3853 18 10.202C18 8.38529 17.4208 6.89779 16.2625 5.73945C15.1042 4.58112 13.6833 4.00195 12 4.00195C10.3167 4.00195 8.89583 4.58112 7.7375 5.73945C6.57917 6.89779 6 8.38529 6 10.202C6 11.3853 6.49167 12.7395 7.475 14.2645C8.45833 15.7895 9.96667 17.4853 12 19.352ZM12 22.002C9.31667 19.7186 7.3125 17.5978 5.9875 15.6395C4.6625 13.6811 4 11.8686 4 10.202C4 7.70195 4.80417 5.71029 6.4125 4.22695C8.02083 2.74362 9.88333 2.00195 12 2.00195C14.1167 2.00195 15.9792 2.74362 17.5875 4.22695C19.1958 5.71029 20 7.70195 20 10.202C20 11.8686 19.3375 13.6811 18.0125 15.6395C16.6875 17.5978 14.6833 19.7186 12 22.002Z"
                                fill="#393939" />
                        </svg>
                    </div>
                    <div class="justify-start text-main text-base font-normal font-['Poppins']">{{ $location }}
                    </div>
                </div>
            </div>
            <div class="flex items-center mt-1 text-sm text-main">
                <div class="inline-flex gap-1.5 justify-center items-center self-stretch">
                    ...
                    <div class="justify-start text-neutral-700 text-base font-normal font-['Poppins']">Update On:
                        {{ $update }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="absolute top-4 right-4">
            <x-internship-details.days :due='$due' />
        </div>
    </div>
</div>
