...
<div class="bg-white rounded-[30px] shadow-[0px_0px_19.899999618530273px_0px_rgba(0,0,0,0.10)] p-6 flex items-center gap-6 mb-8">
    ...
    <div class="relative">
        <img id="profile-preview" class="object-cover w-24 h-24 rounded-full" src="{{ $avatarImage }}" alt="Profile Picture">
...
{{-- Toast Notifications --}}
<!-- Success Toast -->
<div id="success-toast" class="hidden fixed top-4 right-4 z-50 max-w-xs bg-white rounded-xl border border-green-200 shadow-lg transition duration-300 hs-removing:translate-x-5 hs-removing:opacity-0" role="alert" tabindex="-1" aria-labelledby="success-toast-label">
    <div class="flex p-4">
        <div class="flex-shrink-0">
            <svg class="mt-0.5 w-4 h-4 text-green-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="ms-auto">
            <button type="button" class="inline-flex justify-center items-center text-gray-800 rounded-lg opacity-50 shrink-0 size-5 hover:opacity-100 focus:outline-none focus:opacity-100" aria-label="Close" data-hs-remove-element="#success-toast">
...
<!-- Error Toast -->
<div id="error-toast" class="hidden fixed top-4 right-4 z-50 max-w-xs bg-white rounded-xl border border-red-200 shadow-lg transition duration-300 hs-removing:translate-x-5 hs-removing:opacity-0" role="alert" tabindex="-1" aria-labelledby="error-toast-label">
    <div class="flex p-4">
        <div class="flex-shrink-0">
            <svg class="mt-0.5 w-4 h-4 text-red-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="ms-auto">
            <button type="button" class="inline-flex justify-center items-center text-gray-800 rounded-lg opacity-50 shrink-0 size-5 hover:opacity-100 focus:outline-none focus:opacity-100" aria-label="Close" data-hs-remove-element="#error-toast">
                <span class="sr-only">Close</span>
                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M18 6 6 18"></path>
                    <path d="m6 6 12 12"></path>
