            ...
            <div class="flex flex-shrink-0 gap-1 items-center sm:gap-2 md:gap-3 xl:gap-4">
                ...
                <div class="relative">
                    <div id="notification-icon"
                        class="flex justify-center items-center p-1.5 w-8 h-8 rounded-2xl border border-stone-300 sm:w-9 sm:h-9 sm:p-2 sm:rounded-3xl md:w-10 md:h-10 md:p-2.5 xl:w-12 xl:h-12 xl:p-3 xl:rounded-3xl cursor-pointer">
