...
<div id="topbar"
    ...
    <div class="ml-14 mr-4 sm:ml-16 sm:mr-5 md:ml-20 md:mr-6 lg:ml-24 lg:mr-8 xl:ml-[308px] xl:mr-[150px]">
        <div class="flex items-center justify-between"> <!-- Search Bar -->
            ...
            <div class="flex items-center gap-1 sm:gap-2 md:gap-3 xl:gap-4">
                ...
                <!-- Mail Icon -->
                <div
                    class="w-8 h-8 p-1.5 rounded-2xl border border-stone-300 flex justify-center items-center sm:w-9 sm:h-9 sm:p-2 sm:rounded-3xl md:w-10 md:h-10 md:p-2.5 xl:w-12 xl:h-12 xl:p-3 xl:rounded-3xl">
                ...
                <!-- Divider -->
                <div class="w-0 h-6 border-l-2 border-stone-300 mx-1 sm:h-7 sm:mx-1.5 md:h-8 md:mx-2 xl:h-12 xl:mx-3">
                </div>

                <!-- Profile Section -->
                <div class="flex items-center gap-1 sm:gap-1.5 md:gap-2 xl:gap-2.5">
