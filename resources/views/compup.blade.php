...
<div id="hs-large-modal" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 pointer-events-none hs-overlay size-full start-0 z-80" role="dialog" tabindex="-1" aria-labelledby="hs-large-modal-label">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all lg:max-w-4xl lg:w-full m-3 lg:mx-auto min-h-[calc(100%-56px)] flex items-center">
      <div class="flex flex-col w-full bg-white rounded-xl border border-gray-200 pointer-events-auto shadow-2xs">
        <div class="flex justify-between items-center px-4 py-3 border-b border-gray-200">
          <div class="flex gap-4 items-center w-full">
            ...
            <div class="flex flex-col justify-start items-start">
              <div class="inline-flex items-center gap-[3px] mb-1">
                ...
                <div class="text-main text-sm font-normal font-['Poppins']">Malang</div>
              </div>
          ...
          <button type="button" class="inline-flex gap-x-2 justify-center items-center bg-gray-100 rounded-full border border-transparent text-main size-8 hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none" aria-label="Close" data-hs-overlay="#hs-large-modal">
        ...
        <div class="overflow-y-auto p-4 space-y-6">
            <div class="space-y-3">
                <h3 class="text-lg font-semibold text-main font-['Poppins']">UI/UX Designer</h3>
                <x-dashboard.student-pill href="{{ route('student-detail') }}" completed="{{ rand(0, 7) }}"/>
            </div>
            <div class="space-y-3">
                <h3 class="text-lg font-semibold text-main font-['Poppins']">Frontend Developer</h3>
                <x-dashboard.student-pill href="{{ route('student-detail') }}" completed="{{ rand(0, 7) }}"/>
            </div>
        </div>
      </div>
