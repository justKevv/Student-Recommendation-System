<x-dashboard.layout>
    ...
    <x-dashboard.main-content>
        ...
        <x-hero-banner>
            ...
            <!-- CTA Button -->
            <a href="{{ route('internship') }}" class="absolute left-[27px] top-[175px] cursor-pointer hover:cursor-pointer">
                <button class="w-36 h-12 bg-main rounded-[30px] flex items-center justify-center gap-3 px-4 transition-all duration-300 hover:shadow-md hover:scale-105 group cursor-pointer">
